...
static const Preset kFactoryPresets[] = {
    ...
    {"Rock Singer",         80.0f,   1.0f,    0.275f,  0.16f,  0.2f,   4.6f,   1.0f},
    {"Fat Voice",           20.0f,   0.755f,  0.363f,  0.52f,  0.4f,   4.6f,   1.0f},
    {"Flanging Snare",      1.25f,   0.765f,  0.525f,  1.0f,   0.4f,   4.6f,   1.0f},
    {"Stereo to Cymbal",    20.0f,   0.78f,   0.457f,  0.32f,  0.4f,   4.6f,   1.0f},
