...
// all preset-manager UI logic for ClassicChorusUI.
//
...
void ClassicChorusUI::_applyRestoredPresetState()
{
    if (fPresetManager)
...
// ─────────────────────────────────────────────────────────────────────────────
void ClassicChorusUI::_drawPresetManager()
{
    ...
    if (ImGui::Begin("##PresetManager", nullptr, kPmFlags))
    {
        ...
        // ── Column widths ────────────────────────────────────────────────
        const float leftW  = availW * 0.41f;    // NOTE: Slightly wider than other Classic RE plugins
