...
void ClassicChorusUI::_drawChassisBackground(float margin, float rounding)
{
    ...
    // Main panel – base colour rgb(80, 50, 80)
    drawList->AddRectFilled(panelMin, panelMax, IM_COL32(80, 50, 80, 0xff), rounding);
...
void ClassicChorusUI::_drawKjearhusLogo(const ImVec2& size)
{
...
void ClassicChorusUI::_drawPluginName()
{
    ImGui::BeginGroup();

    //
    // Plugin name mark: "Classic Flanger"
    //
    ...
    //
    // "RE-02" model mark: capsule split into two halves.
    // Left  half – transparent background, white "RE".
    // Right half – solid white background,  black "02".
    //
    {
        ...
        const ImVec2 o4_sz  = font->CalcTextSizeA(kFontSz, FLT_MAX, 0.0f, "01");
        ...
        if (ImGui::IsItemHovered(ImGuiHoveredFlags_DelayNormal | ImGuiHoveredFlags_NoSharedDelay))
        {
            ImGui::SetTooltip("\"RE\" stands for Reverse Engineering.\n"
                PLUGIN_NAME_COMMON " RE is an open source recreation of the original Kjaerhus " PLUGIN_NAME_COMMON ".");
        }
    }
